...
Fitcut Mirror 웹 MVP는 정적 HTML/CSS/JS로 export해서 GitHub Pages에 올릴 수 있다.
...
```bash
cd "D:\Codex\Fitcut Mirror\apps\web"
npm run build
```
...
```text
https://minjae9037.github.io/fitcut-mirror/
```

빌드할 때 다음 값을 설정한다.

```text
NEXT_PUBLIC_BASE_PATH=/fitcut-mirror
```
